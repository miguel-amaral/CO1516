// $Id: type_checker.h,v 1.11 2016/05/18 23:22:11 ist178865 Exp $ -*- c++ -*-
...
namespace zu {
  ...
  protected:
	void processComparativeNode(cdk::binary_expression_node * const node, int lvl);
	void processEqNode(cdk::binary_expression_node * const node, int lvl);
	void processAddSub(cdk::binary_expression_node * const node, int lvl);
	void processIntExpression(cdk::binary_expression_node * const node, int lvl);
