// $Id: basic_ast_visitor.h,v 1.6 2016/05/16 21:19:23 ist178865 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_mem_alloc_node(zu::mem_alloc_node * const node, int lvl) = 0;
  ...
  virtual void do_var_dec_node(zu::var_dec_node * const node, int lvl) = 0;
  virtual void do_var_def_node(zu::var_def_node * const node, int lvl) = 0;
  virtual void do_identifier_node(zu::identifier_node * const node, int lvl) =0;
  virtual void do_addressOf_node(zu::addressOf_node * const node, int lvl) =0;
  virtual void do_block_node(zu::block_node * const node, int lvl) = 0;
  virtual void do_new_node(zu::new_node * const node, int lvl) = 0;
};
